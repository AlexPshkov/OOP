...
{
    [Fact]
    public void UrlParser_ParseURL_HttpProtocolWithoutPort_CorrectOutput()
    {
        // Arrange
        string url = "http://www.mysite.com/docs/document1.html?page=30&lang=en#title";

        // Act
        bool result = UrlParser.ParseURL( url, out Protocol protocol, out int port, out string? host,
            out string? document );
    ...
    [Fact]
    public void UrlParser_ParseURL_FtpProtocolWithoutPort_CorrectOutput()
    {
        // Arrange
    ...
    [Fact]
    public void UrlParser_ParseURL_NormalInputWithPort_CorrectOutput()
    {
        // Arrange
    ...
    [Fact]
    public void UrlParser_ParseURL_WithPortWithoutPath_CorrectOutput()
    {
        // Arrange
    ...
    [Fact]
    public void UrlParser_ParseURL_OnlyHost_CorrectOutput()
    {
        // Arrange
    ...
    [Fact]
    public void UrlParser_ParseURL_InvalidPort_GetBadResult()
    {
        // Arrange
        string url = "http://www.mysite.com:/";
    ...
    [Fact]
    public void UrlParser_ParseURL_InvalidHost_GetBadResult()
    {
        // Arrange
        string url = "http://";
    ...
    [Fact]
    public void UrlParser_ParseURL_EmptyUrl_GetBadResult()
    {
        // Arrange
        string url = "";
